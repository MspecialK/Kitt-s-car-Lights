...
set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports dec_speed]
set_property IOSTANDARD LVCMOS33 [get_ports dec_tail]
set_property IOSTANDARD LVCMOS33 [get_ports inc_speed]
set_property IOSTANDARD LVCMOS33 [get_ports inc_tail]
set_property PACKAGE_PIN W5 [get_ports clk]
set_property PACKAGE_PIN W19 [get_ports dec_speed]
set_property PACKAGE_PIN U17 [get_ports dec_tail]
set_property PACKAGE_PIN T17 [get_ports inc_speed]
set_property PACKAGE_PIN T18 [get_ports inc_tail]
